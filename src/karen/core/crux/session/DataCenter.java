...
public class DataCenter {
	...
	public DataCenter() {
		...
		if (!usersData.containsKey(getZkSession())) {
			usersData.put(getZkSession(), new UserData(Executions.getCurrent()
					.getRemoteAddr()));
		} else {
	...
	public void registerThread() {
		...
		MySessionListener.addTask(DataCenter.getZkSession(),
				new MessageSystemTask(desktop, new EventListener<Event>() {

					public void onEvent(Event event) throws Exception {
						UtilDialog.showMessageSystem(DataCenter
								.getMessageSystem());
					}
				}));
	}

	public static void updateSrcPageContent(Object objeto, Operacion operacion,
			String archivoZul) {
		...
		BindUtils.postGlobalCommand(null, null,
				"updateSrcPageContentByOperacion", args);
	}

	@GlobalCommand
	@NotifyChange({ "srcPageContent" })
	public void updateSrcPageContentByOperacion(
			@BindingParam("entity") Object entity,
			@BindingParam("operacion") Operacion operacion,
			@BindingParam("archivoZul") String archivoZul) {
	...
	public static void updateSrcPageContent(NodoMenu nodoMenu) {
		...
		BindUtils.postGlobalCommand(null, null,
				"updateSrcPageContentByNodoMenu", args);
	}

	@GlobalCommand
	@NotifyChange("srcPageContent")
	public void updateSrcPageContentByNodoMenu(
			@BindingParam("nodoMenu") NodoMenu nodoMenu) {
	...
	public static void updateTitle(String title) {
		...
		BindUtils.postGlobalCommand(null, null, "updateTheTitleHeaderCenter",
				args);
	}
	...
	public int getSizeNotificaciones() {
		return usersSecurityData.get(getZkSession()).getUsuario()
				.getNotificacionUsuariosPendientes().size();
	}

	public List<NotificacionUsuario> getNotificaciones() {
		return usersSecurityData.get(getZkSession()).getUsuario()
				.getNotificacionUsuariosPendientes();
	}

	public String getNombreUsuario() {
		return usersSecurityData.get(getZkSession()).getUsuario().getCorreo();
	}
